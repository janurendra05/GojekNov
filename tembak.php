...
echo color("red"," =====================================\n");
echo color("purple","|       Tool NeGay Sama Gojek         |\n");
echo color("red","| Auto create Gojek X Redeem voucher  |\n");
echo color("green","|         github: janurendra05        |\n");
echo color("red","| Subscribe :Andrea Zakharia - Piano  |\n");
echo color("blue","| ReCodeBy : Fans LORD ANDREA         |\n");
echo "|        Autors : Andrea X Zaky       |\n";
...
// function change(){
        ...
        sleep(3);
        $goride1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"GOFOODSANTAI19"}');
